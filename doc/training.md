# 🚀 Thai OCR Training Pipeline

> **Updated**: 11 สิงหาคม 2025 - จากประสบการณ์การเทรนจริงที่สำเร็จ

## 📚 คู่มือการเทรน (Training Guides)

- [**Basic Training Guide**](manual-training-guide.md) - วิธีการเทรนขั้นพื้นฐาน
- [**Advanced Training Guide**](advanced-training-guide.md) - คู่มือการเลือก architecture และ GPU

## 🎯 การเทรนจริงที่สำเร็จ

### ✅ **Numbers OCR Training (7 สิงหาคม 2025)**
- **Dataset**: 304 ไฟล์ (ตัวเลข 0-9)
- **Instance**: `ml.g4dn.xlarge` (GPU)
- **เวลาเทรน**: 13 นาที (781 วินาที)
- **ค่าใช้จ่าย**: $0.11 USD
- **สถาปัตยกรรม**: CRNN + MobileNetV3
- **ผลลัพธ์**: โมเดลพร้อมใช้งาน ✅

### 📊 การเปรียบเทียบ Instance Types

| Instance Type | ราคา/ชั่วโมง | GPU | เหมาะสำหรับ | เวลาจริง | ค่าใช้จ่ายจริง |
|---------------|-------------|-----|------------|---------|-------------|
| ml.m5.large   | $0.115     | ❌  | CPU only   | 3-4 ชม  | $0.35-$0.46 |
| **ml.g4dn.xlarge** | **$0.526** | **✅** | **Dataset เล็ก** | **13 นาที** | **$0.11** ⭐ |
| ml.g4dn.2xlarge | $0.752    | ✅  | Dataset ใหญ่ | 8-10 นาที | $0.10-$0.12 |

**คำแนะนำ**: ใช้ `ml.g4dn.xlarge` สำหรับ dataset เล็ก - เร็วที่สุดและถูกที่สุด!
